...
form.addEventListener('submit', function (e) {
    ...
    if ((tb === '') || (tb < 0) || (isNaN(tb))) {
        ...
        if (bmi < 18.5) {
            ...
            showAdditionalInfo('kurang', 'https://imgur.com/9GBukNt.jpg', 'Anda memiliki kekurangan berat badan. Sarankan untuk meningkatkan asupan nutrisi.');
        } else if (bmi >= 18.5 && bmi <= 24.9) {
            pesan.innerHTML = "Normal";
            showAdditionalInfo('normal', 'https://imgur.com/SKoBaI8.jpg', 'Berat badan Anda normal. Lanjutkan gaya hidup sehat Anda!');
        } else if (bmi >= 25.0 && bmi <= 29.9) {
            pesan.innerHTML = "Kelebihan Berat Badan";
            showAdditionalInfo('berlebih', 'https://imgur.com/5PBHwHS.jpg', 'Anda memiliki kelebihan berat badan. Sarankan untuk mengurangi asupan kalori dan meningkatkan aktivitas fisik.');
        } else {
            pesan.innerHTML = "Kegemukan Obsesitas";
            showAdditionalInfo('obsesitas', 'https://imgur.com/f8I0U1w.jpg', 'Anda memiliki kegemukan obsesitas. Sarankan untuk konsultasi dengan dokter dan mengikuti program penurunan berat badan yang sehat.');
        }
